# client-error-recovery Specification

## Purpose
Governs how the client contains an uncaught render error: a themed fallback screen with a recovery
action, instead of unmounting the whole app to a blank page.

# numeric-reveal-visualization Specification

## Purpose
Governs how the client visualizes the reveal of a resolved numeric (`Tip`) question: an
archery-target metaphor replacing the plain number line, so relative closeness reads at a glance.

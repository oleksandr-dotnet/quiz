...
On viewports narrower than the client's phone breakpoint, every interactive control the viewer
taps to act (dock buttons, answer options, the numeric keypad) SHALL present a tappable area of at
